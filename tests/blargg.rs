...
fn test_nes_instr_01() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/01-basics.nes",
    ));
}
...
fn test_nes_instr_02() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/02-implied.nes",
    ));
}
...
fn test_nes_instr_03() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/03-immediate.nes",
    ));
}
...
fn test_nes_instr_04() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/04-zero_page.nes",
    ));
}
...
fn test_nes_instr_05() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/05-zp_xy.nes",
    ));
}
...
fn test_nes_instr_06() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/06-absolute.nes",
    ));
}
...
fn test_nes_instr_07() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/07-abs_xy.nes",
    ));
}
...
fn test_nes_instr_08() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/08-ind_x.nes",
    ));
}
...
fn test_nes_instr_09() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/09-ind_y.nes",
    ));
}
...
fn test_nes_instr_10() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/10-branches.nes",
    ));
}
...
fn test_nes_instr_11() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/11-stack.nes",
    ));
}
...
fn test_nes_instr_12() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/12-jmp_jsr.nes",
    ));
}
...
fn test_nes_instr_13() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/13-rts.nes",
    ));
}
...
fn test_nes_instr_14() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/14-rti.nes",
    ));
}
...
fn test_nes_instr_15() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/15-brk.nes",
    ));
}
...
fn test_nes_instr_16() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_test-v5/rom_singles/16-special.nes",
    ));
}
...
fn test_instr_misc_01() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_misc/rom_singles/01-abs_x_wrap.nes",
    ));
}
...
fn test_instr_misc_02() {
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_misc/rom_singles/02-branch_wrap.nes",
    ));
}
...
fn test_instr_misc_03() {
    ...
    run_blargg_test(&Path::new(
        "roms/nes-test-roms/instr_misc/rom_singles/03-dummy_reads.nes",
    ));
}
...
fn blargg_test(rom_path: &Path, expect_success: bool) {
    ...
    common::run_test(rom_path, None, |addr_space| {
        let marker = (
