...
test_suite! {
    ...
    TEST_APULengthTable,
    TEST_FrameCounterIRQ => Err(Error::Code(21)), // The Frame Counter Interrupt flag should not have been set 29830 cycles after resetting the frame counter if supressing Frame Counter Interrupts.
