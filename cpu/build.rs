...
impl ToTokens for Op {
    fn to_tokens(&self, tokens: &mut proc_macro2::TokenStream) {
        let tt = match self {
            ...
            Op::PHA => quote!(operations::pha),
            Op::PHP => quote!(operations::php),
            Op::PLA => quote!(operations::pla),
            Op::PLP => quote!(operations::plp),
            Op::ROL => quote!(operations::rol),
            Op::ROR => quote!(operations::ror),
            Op::RTI => quote!(operations::rti),
            Op::RTS => quote!(operations::rts),
